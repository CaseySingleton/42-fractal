...
/*   Updated: 2018/06/02 22:07:11 by csinglet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct		s_mlx
{
	...
	t_cam			*cam;
	t_keys			*keys;
	int				(*fractal_funciton)(double, double, struct s_mlx *mlx);
	int				max_iterations;
	int				color_choice;
	double			x_offset;
	double			y_offset;
...
void				matrix_multiply(float dst[4][4], float m1[4][4],
						float m2[4][4]);
void				matrix_translate(float matrix[4][4], float x, float y,
						float z);
void				matrix_set_scale(float matrix[4][4], float x, float y,
						float z);
